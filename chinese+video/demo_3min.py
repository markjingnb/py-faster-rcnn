...
def demo_img(net, image):
    ...
    NMS_THRESH = 0.3
    im = im[:, :, (2, 1, 0)]
    fig2, ax = plt.subplots(figsize=(16, 9),frameon=False)
    #ax.imshow(im, aspect='equal')
...
#        print('end\n\n\n')
    ...
    plt.savefig('output6_123.png', dpi = 120,bbox_inches=extent)
    ...
    im1 = cv2.imread('output6_123.png')
    return im1
...
def jnb_demo_video(net):
	...
	capture = cv2.VideoCapture('6.MOV')
	...
	#im = plt.imshow(im1, animated=True)
		...
		#cv2.imwrite('output/t'+str(i)+'.jpg',im2);
		im2 = cv2.cvtColor(im2,cv2.COLOR_BGR2RGB)
		im2=demo_img(net, im2)
		im2 = cv2.cvtColor(im2,cv2.COLOR_RGB2BGR)
       	        #os.system("ffmpeg  -f image2 -i 123.jpg output.mp4")
       	        cv2.imwrite('output6/'+str(i)+'.png',im2);
		print(i)
...
#    im_names = ['000456.jpg', '000542.jpg', '001150.jpg',
 #               '001763.jpg', '004545.jpg']
    os.system('rm output6/*.png')
    os.system('rm output6/*.mp4')
    im_names = ['jnb.jpg']
    for im_name in im_names:
        ...
        #demo(net, im_name)
        jnb_demo_video(net)
    os.system('ffmpeg -y -f image2 -r 30 -i output6/%d.png  -r 30 -b:v 17423K  output6/test.mp4')
    #plt.show()
